...
export const metadata: Metadata = {
  ...
  description: 'Creative and affordable web design solutions tailored to your needs. As a dedicated developer, I bring fresh ideas and a personal touch to your online presence.',
  ...
  openGraph: {
    title: 'Sahad Daily | Freelance Web Design by a Passionate Developer',
    description: 'Get creative and affordable web design solutions from a dedicated developer. I bring fresh ideas and a personal touch to help you achieve your online goals.',
    type: 'website',
    locale: 'en_US',
